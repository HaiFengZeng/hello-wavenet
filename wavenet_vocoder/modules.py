...
def Conv1d1x1(in_channels, out_channels, bias=True, weight_normalization=True, kernel_size=1):
    ...
    if weight_normalization:
        ...
        return conv.Conv1d(in_channels, out_channels, kernel_size=kernel_size, padding=0,
                           dilation=1, bias=bias)


def Conv1d2x1(in_channels, out_channels, bias=True, weight_normalization=True):
    """1-by-1 convolution layer
    """
    if weight_normalization:
        assert bias
        return Conv1d(in_channels, out_channels, kernel_size=2, padding=0,
                      dilation=1, bias=bias, std_mul=1.0)
    else:
        return conv.Conv1d(in_channels, out_channels, kernel_size=2, padding=0,
                           dilation=1, bias=bias)
...
class ResidualConv1dGLU(nn.Module):
    ...
    def __init__(self, residual_channels, gate_channels, kernel_size,
                 ...
                 bias=True, weight_normalization=True, condition=None, *args, **kwargs):
    ...
    def _forward(self, x, c=None, g=None, is_incremental=False, condition=None):
        ...
        if condition is None:
            ...
            # global conditioning --set to None
            if g is not None:
            ...
            c_a, c_b = condition.split(condition.size(splitdim) // 2, dim=splitdim)
            a, b = a + c_a, b + c_b
