...
if __name__ == "__main__":
    args = {
        '--conditional': '/home/jinqiangzeng/work/pycharm/wavenet_vocoder/data/ljspeech/ljspeech-mel-00002.npy',
        '--file-name-suffix': '',
        '--help': False,
        ...
        '--output-html': False,
        '--speaker-id': None,
        '<checkpoint>': '/home/jinqiangzeng/work/pycharm/wavenet_vocoder/checkpoints_65536_mel_condition/20180127_mixture_lj_checkpoint_step000410000_ema.pth',
        '<dst_dir>': '/home/jinqiangzeng/work/pycharm/wavenet_vocoder/syn'}
    ...
    if conditional_path is not None:
        c = np.load(conditional_path)
        file_name_suffix = conditional_path.split('/')[-1].split('.')[0]
    else:
        c = None
