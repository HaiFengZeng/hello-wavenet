...
The goal of the repository is working on  Parallel WaveNet vocoder!!!
 - this repository is based on https://github.com/r9y9/wavenet_vocoder.git
 - I'm still working on it and hope people can help to get it work.
 - most code borrowed from https://github.com/r9y9/wavenet_vocoder.git and ideas from discussion in `https://github.com/r9y9/wavenet_vocoder/issues/7`
   and  `https://github.com/kensun0/Parallel-Wavenet/issues/1`
 - there're many bugs in code and also maybe wrong ideas, any discussions are welcomed.
# training
 - A pre-trained teacher model is required from original wavenet_vocoder(I used a 700k-checkpoint step as teacher)
   and most of parameters comes from the original paper ,maybe you should change some hyper-parameters
 - The student wavenet is in student_wavenet.py.
 - The training code is in train_student.py,you should try to modify the code for your own condition
>>>>>>> fix of nothing
